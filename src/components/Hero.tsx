        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <Link
                href="/book"
                className="inline-flex items-center gap-2 rounded-2xl bg-primary px-8 py-4 text-lg font-semibold text-white shadow-premium transition-all hover:bg-primary/90 hover:scale-[1.03] active:scale-[0.97]"
              >
              ...
              <Link
                href="#services"
                className="inline-flex items-center gap-2 rounded-2xl px-6 py-4 text-lg font-semibold text-foreground/70 transition-all hover:bg-foreground/5 hover:text-foreground"
              >
                Our Services
            ...
            <div className="mt-12 flex items-center gap-8 border-t border-foreground/5 pt-10">
              <div>
          ...
          >
            ...
            <motion.div
              ...
              className="glass absolute -bottom-8 -left-8 z-20 flex items-center gap-4 rounded-3xl p-6 shadow-premium backdrop-blur-xl"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-accent shadow-premium">
