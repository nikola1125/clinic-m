...
export function Footer() {
  return (
    <footer className="border-t border-foreground/5 bg-white py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4">
              {["General Medicine", "Cardiology", "Neurology", "Pediatrics", "Ophthalmology"].map((item) => (
                <li key={item}>
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider text-foreground">Clinic</h3>
            <ul className="mt-6 space-y-4">
              {["Our Doctors", "Success Stories", "About Zenith", "Career with us", "Contact"].map((item) => (
                <li key={item}>
                  <Link href="#doctors" className="text-sm text-foreground/60 hover:text-primary transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4">
              ...
              <li className="flex items-start gap-3 text-sm text-foreground/60">
                ...
                <span>123 Medical Plaza,<br />Wellness City, CA 90210</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-16 border-t border-foreground/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-foreground/40 text-center md:text-left">
            © {new Date().getFullYear()} Zenith Health Group. All medical services provided by licensed specialists.
          </p>
          <div className="flex gap-8">
            <Link href="#" className="text-xs text-foreground/30 hover:text-primary transition-colors">Privacy Policy</Link>
            <Link href="#" className="text-xs text-foreground/30 hover:text-primary transition-colors">Terms of Service</Link>
            <Link href="#" className="text-xs text-foreground/30 hover:text-primary transition-colors">Cookie Settings</Link>
          </div>
        </div>
      </div>
    </footer>
